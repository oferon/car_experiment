...
function initSprites(img) {
	...
	s_bird = [
		new Sprite(img, 141, 165, 33, 12),
		new Sprite(img, 141, 178, 33, 12),
		new Sprite(img, 141, 191, 33, 12)
	];
	...
	s_buttons = {
		...
		Shuttle: new Sprite(img, 0, 262, 65, 40), // blank 
		Detour: new Sprite(img, 70, 262, 65, 40), // blank
